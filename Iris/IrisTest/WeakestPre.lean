...
/-- info: ⊢ ∀ Φ, P -∗ (▷ ∀ x y, Q -∗ Φ (x + y)) -∗ WP e @ s ; E {{ Φ }} : Prop -/
#guard_msgs in
#check {{ P }} e @ s ; E {{ x y , RET (x+y) ; Q }}

/-- info: iprop(□ ∀ Φ, P -∗ (▷ ∀ x y, Q -∗ Φ (x + y)) -∗ WP e @ s ; E {{ Φ }}) : PROP -/
#guard_msgs in
#check iprop({{ P }} e @ s ; E {{ x y , RET (x+y) ; Q }})

/-- info: ⊢ ∀ Φ, P -∗ (▷ ∀ x y, Q -∗ Φ (x + y)) -∗ WP e @ E {{ Φ }} : Prop -/
#guard_msgs in
#check {{ P }} e @ E {{ x y , RET (x+y) ; Q }}

/-- info: iprop(□ ∀ Φ, P -∗ (▷ ∀ x y, Q -∗ Φ (x + y)) -∗ WP e @ E {{ Φ }}) : PROP -/
#guard_msgs in
#check iprop({{ P }} e @ E {{ x y , RET (x+y) ; Q }})
...
/-- info: ⊢ ∀ Φ, P -∗ (▷ ∀ x y, Q -∗ Φ (x + y)) -∗ WP e {{ Φ }} : Prop -/
#guard_msgs in
#check {{ P }} e {{ x y , RET (x+y) ; Q }}

/-- info: iprop(□ ∀ Φ, P -∗ (▷ ∀ x y, Q -∗ Φ (x + y)) -∗ WP e {{ Φ }}) : PROP -/
#guard_msgs in
#check iprop({{ P }} e {{ x y , RET (x+y) ; Q }})
...
/-- info: ⊢ ∀ Φ, P -∗ ▷ (Q -∗ Φ 0) -∗ WP e @ s ; E {{ Φ }} : Prop -/
#guard_msgs in
#check {{ P }} e @ s ; E {{ RET 0 ; Q }}

/-- info: iprop(□ ∀ Φ, P -∗ ▷ (Q -∗ Φ 0) -∗ WP e @ s ; E {{ Φ }}) : PROP -/
#guard_msgs in
#check iprop({{ P }} e @ s ; E {{ RET 0 ; Q }})

/-- info: ⊢ ∀ Φ, P -∗ ▷ (Q -∗ Φ 0) -∗ WP e @ E {{ Φ }} : Prop -/
#guard_msgs in
#check {{ P }} e @ E {{ RET 0 ; Q }}

/-- info: iprop(□ ∀ Φ, P -∗ ▷ (Q -∗ Φ 0) -∗ WP e @ E {{ Φ }}) : PROP -/
#guard_msgs in
#check iprop({{ P }} e @ E {{ RET 0 ; Q }})
...
/-- info: ⊢ ∀ Φ, P -∗ ▷ (Q -∗ Φ 0) -∗ WP e {{ Φ }} : Prop -/
#guard_msgs in
#check {{ P }} e {{ RET 0 ; Q }}

/-- info: iprop(□ ∀ Φ, P -∗ ▷ (Q -∗ Φ 0) -∗ WP e {{ Φ }}) : PROP -/
#guard_msgs in
#check iprop({{ P }} e {{ RET 0 ; Q }})
...
#guard_msgs in
#check iprop([{ P }] e @ s ; E [{ RET v; Q }])

/-- info: iprop(□ ∀ Φ, P -∗ (Q -∗ Φ v) -∗ WP e @ E [{ Φ }]) : PROP -/
#guard_msgs in
#check iprop([{ P }] e @ E [{ RET v; Q }])
...
#guard_msgs in
#check iprop([{ P }] e [{ (x : Val), RET x; Q }])

/-- info: iprop(□ ∀ Φ, P -∗ (∀ x, Q -∗ Φ v) -∗ WP e [{ Φ }]) : PROP -/
#guard_msgs in
#check iprop([{ P }] e [{ _, RET v; Q }])
...
#guard_msgs in
#check WP hl(if #0 < #1 then #1 else #2) {{ Φ }}
/-- info: WP hl((λ x, x)) {{ Φ }} : PROP -/
#guard_msgs in
#check WP hl(λ x, x) {{ Φ }}
/-- info: WP hl((rec f x := f x)) {{ Φ }} : PROP -/
#guard_msgs in
#check WP hl(rec f x := f x) {{ Φ }}
/-- info: WP hl(#1; #2) {{ Φ }} : PROP -/
#guard_msgs in
#check WP hl(#1; #2) {{ Φ }}
/-- info: WP hl((#1, #2)) {{ Φ }} : PROP -/
...
#guard_msgs in
#check WP hl(if #1 < #2 then #1 + #1 else #0) {{ Φ }}
/-- info: WP hl(#1) {{ v, ⌜v = hl_val(#1)⌝ }} : PROP -/
#guard_msgs in
#check (WP hl(#1) {{ v, ⌜v = hl_val(#1)⌝ }} : PROP)
...
/-- info: ⊢ ∀ Φ, P -∗ ▷ (Q -∗ Φ hl_val(#1)) -∗ WP hl(#1) {{ Φ }} : Prop -/
#guard_msgs in
#check {{ P }} hl(#1) {{ RET hl_val(#1); Q }}
/-- info: iprop(□ ∀ Φ, P -∗ ▷ (Q -∗ Φ hl_val(#1)) -∗ WP hl(#1) {{ Φ }}) : PROP -/
#guard_msgs in
#check iprop({{ P }} hl(#1) {{ RET hl_val(#1); Q }})
/-- info: ⊢ ∀ Φ, P -∗ (▷ ∀ x, Q -∗ Φ x) -∗ WP hl((#1 + #2)) {{ Φ }} : Prop -/
#guard_msgs in
#check {{ P }} hl(#1 + #2) {{ x, RET x; Q }}
/-- info: iprop(□ ∀ Φ, P -∗ (▷ ∀ x, Q -∗ Φ x) -∗ WP hl((#1 + #2)) {{ Φ }}) : PROP -/
#guard_msgs in
#check iprop({{ P }} hl(#1 + #2) {{ x, RET x; Q }})
/-- info: ⊢ ∀ Φ, P -∗ (▷ ∀ x, Q -∗ Φ x) -∗ WP hl((#1 < #2)) {{ Φ }} : Prop -/
#guard_msgs in
#check {{ P }} hl(#1 < #2) {{ x, RET x; Q }}
/-- info: iprop(□ ∀ Φ, P -∗ (▷ ∀ x, Q -∗ Φ x) -∗ WP hl((#1 < #2)) {{ Φ }}) : PROP -/
#guard_msgs in
#check iprop({{ P }} hl(#1 < #2) {{ x, RET x; Q }})
/-- info: ⊢ ∀ Φ, P -∗ (▷ ∀ x, Q -∗ Φ x) -∗ WP hl(if (#0 < #1) then #1 else #2) {{ Φ }} : Prop -/
#guard_msgs in
#check {{ P }} hl(if #0 < #1 then #1 else #2) {{ x, RET x; Q }}
/--
info: iprop(□ ∀ Φ, P -∗ (▷ ∀ x, Q -∗ Φ x) -∗ WP hl(if (#0 < #1) then #1 else #2) {{ Φ }}) : PROP
-/
#guard_msgs in
#check iprop({{ P }} hl(if #0 < #1 then #1 else #2) {{ x, RET x; Q }})
/-- info: ⊢ ∀ Φ, P -∗ (▷ ∀ x, Q -∗ Φ x) -∗ WP hl((λ x, x)) {{ Φ }} : Prop -/
#guard_msgs in
#check {{ P }} hl(λ x, x) {{ x, RET x; Q }}
/-- info: iprop(□ ∀ Φ, P -∗ (▷ ∀ x, Q -∗ Φ x) -∗ WP hl((λ x, x)) {{ Φ }}) : PROP -/
#guard_msgs in
#check iprop({{ P }} hl(λ x, x) {{ x, RET x; Q }})
/-- info: ⊢ ∀ Φ, P -∗ (▷ ∀ x, Q -∗ Φ x) -∗ WP hl((rec f x := f x)) {{ Φ }} : Prop -/
#guard_msgs in
#check {{ P }} hl(rec f x := f x) {{ x, RET x; Q }}
/-- info: iprop(□ ∀ Φ, P -∗ (▷ ∀ x, Q -∗ Φ x) -∗ WP hl((rec f x := f x)) {{ Φ }}) : PROP -/
#guard_msgs in
#check iprop({{ P }} hl(rec f x := f x) {{ x, RET x; Q }})
/-- info: ⊢ ∀ Φ, P -∗ (▷ ∀ x, Q -∗ Φ x) -∗ WP hl(#1; #2) {{ Φ }} : Prop -/
#guard_msgs in
#check {{ P }} hl(#1; #2) {{ x, RET x; Q }}
/-- info: iprop(□ ∀ Φ, P -∗ (▷ ∀ x, Q -∗ Φ x) -∗ WP hl(#1; #2) {{ Φ }}) : PROP -/
...
#guard_msgs in
#check iprop({{ P }} hl((#1, #2)) {{ x, RET x; Q }})
/-- info: ⊢ ∀ Φ, P -∗ (▷ ∀ x, Q -∗ Φ x) -∗ WP hl(ref(#0)) {{ Φ }} : Prop -/
#guard_msgs in
#check {{ P }} hl(ref(#0)) {{ x, RET x; Q }}
/-- info: iprop(□ ∀ Φ, P -∗ (▷ ∀ x, Q -∗ Φ x) -∗ WP hl(ref(#0)) {{ Φ }}) : PROP -/
#guard_msgs in
#check iprop({{ P }} hl(ref(#0)) {{ x, RET x; Q }})
/--
info: ⊢ ∀ Φ, P -∗ (▷ ∀ x, Q -∗ Φ x) -∗ WP hl(if (#1 < #2) then (#1 + #1) else #0) {{ Φ }} : Prop
-/
#guard_msgs in
#check {{ P }} hl(if #1 < #2 then #1 + #1 else #0) {{ x, RET x; Q }}
/--
info: iprop(□ ∀ Φ, P -∗ (▷ ∀ x, Q -∗ Φ x) -∗ WP hl(if (#1 < #2) then (#1 + #1) else #0) {{ Φ }}) : PROP
-/
#guard_msgs in
#check iprop({{ P }} hl(if #1 < #2 then #1 + #1 else #0) {{ x, RET x; Q }})
/-- info: ⊢ ∀ Φ, P -∗ (▷ ∀ v, ⌜v = hl_val(#1)⌝ -∗ Φ v) -∗ WP hl(#1) {{ Φ }} : Prop -/
#guard_msgs in
#check {{ P }} hl(#1) {{ v, RET v; ⌜v = hl_val(#1)⌝ }}
/-- info: iprop(□ ∀ Φ, P -∗ (▷ ∀ v, ⌜v = hl_val(#1)⌝ -∗ Φ v) -∗ WP hl(#1) {{ Φ }}) : PROP -/
#guard_msgs in
#check iprop({{ P }} hl(#1) {{ v, RET v; ⌜v = hl_val(#1)⌝ }} : PROP)
