    ...
    for alt in alts do
      ...
      for l in lhs do
        ...
        | `(inductionAltLHS| | $_:hole $[$vars]*) =>
          ...
          return ⟨tac, parsedAlts, some ⟨.anonymous, ← parseVars vars, tacs, alt⟩⟩
...
private def iInductionCore {u} {prop : Q(Type u)} {bi : Q(BI $prop)} {e}
  ...
  | some parsedAlts =>
    ...
    if recCtors.length == parsedAlts.alts.size then
      ...
      | some w =>
        throwErrorAt w.stx "iinduction: wildcard alternative is not needed"
      | none => pure ()
        ...
        s.mvarId.withContext do
          ...
          | some parsedAlts =>
            ...
            | some ⟨_, vars, _, stx⟩ =>
              ...
              | throwErrorAt stx "iinduction: fail to parse induction subgoal"
              ...
              | throwErrorAt stx "iinduction: spatial context should be empty"
              ...
              | some tacticSeq => k st.newHyps irisGoal.goal <| fun hyps goal => do
                  ...
                  | some [] =>
                    throwErrorAt stx
                      "iinduction: alternative `{ctor.getString!}` is not needed"
                  | _ => pure ()
                  pure pf
