...
private def addIntoIH {u} {prop : Q(Type u)} {bi : Q(BI $prop)} {e}
  ...
  | throwError "iinduction: type class synthesis failed"

  let dummyIdent ← `(binderIdent| _)
  let ⟨newName, newIdent⟩ ← getFreshName dummyIdent

  let ⟨ivar, newHyps⟩ ← Hyps.addWithInfo bi dummyIdent q(true) Q hyps
