    ...
    fun hyps' goal' k => do
      ...
      for ⟨s, ctor⟩ in subgoals.toList.zip caseNames do
        s.mvarId.withContext do
          ...
          | none => withoutFVars (u := 0) ihFVars.toArray <| k st.newHyps irisGoal.goal (addBIGoal · · ctor)
          | some tacticSeq => withoutFVars (u := 0) ihFVars.toArray <| k st.newHyps irisGoal.goal (addBIGoalRunTactic · · ctor tacticSeq)
