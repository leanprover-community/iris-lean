...
@[rocq_alias MakeSep, rocq_alias KnownLMakeSep, rocq_alias KnownRMakeSep]
...
@[rocq_alias MakeAnd, rocq_alias KnownLMakeAnd, rocq_alias KnownRMakeAnd]
...
@[rocq_alias MakeOr, rocq_alias KnownLMakeOr, rocq_alias KnownRMakeOr]
...
@[rocq_alias MakeAffinely, rocq_alias KnownMakeAffinely]
...
@[rocq_alias MakeIntuitionistically, rocq_alias KnownMakeIntuitionistically]
...
@[rocq_alias MakeAbsorbingly, rocq_alias KnownMakeAbsorbingly]
...
@[rocq_alias MakePersistently, rocq_alias KnownMakePersistently]
...
@[rocq_alias MakeLaterN, rocq_alias KnownMakeLaterN]
...
@[rocq_alias MakeExcept0, rocq_alias KnownMakeExcept0]
