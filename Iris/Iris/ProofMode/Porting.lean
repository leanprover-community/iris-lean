...
#rocq_concept proofmode "Tactics" "iPure (basic)" ported "ipu<re"
...
#rocq_concept proofmode "Specialization Patterns" "SGoal (Kind: Modal) (pattern: [>H1 ...])" ported "pattern: [>H1 ...]"
...
#rocq_concept proofmode "Specialization Patterns" "SAutoFrame (Kind: Intuitionistic) (pattern: [#$])" ported "pattern: [#$]"
#rocq_concept proofmode "Specialization Patterns" "SAutoFrame (Kind: Modal) (pattern: [>$])" ported "pattern: [>$]"
