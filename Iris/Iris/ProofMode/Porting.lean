...
#rocq_concept proofmode "Tactics"
  "iSpecialize (duplicate context for persistent conclusion)" ported "ispecialize"
...
#rocq_concept proofmode "Tactics" "iIntros (all intro patterns)" ported "iintro"
...
#rocq_concept proofmode "Tactics" "iAaccIntro" ported "iaacc_intro"
#rocq_concept proofmode "Tactics" "awp_apply" missing
...
#rocq_concept proofmode "Intro Patterns"
  "IList (pattern: [ ... | ... ])" ported "pattern: ( ... | ... )"
...
#rocq_concept proofmode "Intro Patterns"
  "IClearFrame (pattern: {$selpat})" ported "pattern: { $H, ... }"

#rocq_concept proofmode "Specialization Patterns" ported ""
#rocq_concept proofmode "Specialization Patterns"
  "SIdent (pattern: H)" ported "pattern: H"
#rocq_concept proofmode "Specialization Patterns"
  "Nested (pattern: (H spat ...))" ported "pattern: (H $$ spat₁ ... spatₙ)"
#rocq_concept proofmode "Specialization Patterns"
  "SPureGoal (pattern: [%])" ported "pattern: %"
#rocq_concept proofmode "Specialization Patterns"
  "SGoal (Kind: Spatial) (pattern: [H1 ...])" ported "pattern: [H1 ...]"
#rocq_concept proofmode "Specialization Patterns"
  "SGoal (Kind: Intuitionistic) (pattern: [#H1 ...])" ported "pattern: [#H1 ...]"
#rocq_concept proofmode "Specialization Patterns"
  "SGoal (Kind: Modal) (pattern: [>H1 ...])" ported "pattern: [>H1 ...]"
#rocq_concept proofmode "Specialization Patterns"
  "SGoal (Negate) (pattern: [-H1 ...])" ported "pattern: [-H1 ...]"
#rocq_concept proofmode "Specialization Patterns"
  "SGoal (Frame) (pattern: [$H1])" ported "pattern: [$H1]"
#rocq_concept proofmode "Specialization Patterns"
  "SGoal (Hyps) (pattern: [H1 ...])" ported "pattern: [H1 ...]"
#rocq_concept proofmode "Specialization Patterns"
  "SGoal (Done) (pattern: [... //])" ported "pattern: [... //]"
#rocq_concept proofmode "Specialization Patterns"
  "SAutoFrame (Kind: Spatial) (pattern: [$])" ported "pattern: [$]"
#rocq_concept proofmode "Specialization Patterns"
  "SAutoFrame (Kind: Intuitionistic) (pattern: [#$])" ported "pattern: [#$]"
#rocq_concept proofmode "Specialization Patterns"
  "SAutoFrame (Kind: Modal) (pattern: [>$])" ported "pattern: [>$]"
