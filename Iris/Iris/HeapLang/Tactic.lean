...
def extractEctxItem : Q(Exp) → MetaM (Option Q(ECtxItem) × Q(Exp))
  ...
  | ~q(.allocN $e (.ofVal $v₂))               => return (some q(allocNL $v₂), e)
  ...
  | ~q(.xchg $e (.ofVal $v₂))                 => return (some q(xchgL $v₂), e)
  | ~q(.xchg $e₁ $e)                          => return (some q(xchgR $e₁), e)
  | ~q(.cmpXchg $e (.ofVal $v₁) (.ofVal $v₂)) => return (some q(cmpXchgL $v₁ $v₂), e)
  | ~q(.cmpXchg $e₀ $e (.ofVal $v₂))          => return (some q(cmpXchgM $e₀ $v₂), e)
  | ~q(.cmpXchg $e₀ $e₁ $e)                   => return (some q(cmpXchgR $e₀ $e₁), e)
  | ~q(.faa $e (.ofVal $v₂))                  => return (some q(faaL $v₂), e)
  | ~q(.faa $e₁ $e)                           => return (some q(faaR $e₁), e)
  | ~q(.resolve $e (.ofVal $v₁) (.ofVal $v₂)) => extractResolveL q(.resolve $e (.ofVal $v₁) (.ofVal $v₂))
  | ~q(.resolve $e₀ $e (.ofVal $v₂))          => return (some q(resolveM $e₀ $v₂), e)
  | ~q(.resolve $e₀ $e₁ $e)                   => return (some q(resolveR $e₀ $e₁), e)
  | e => return (none, e)
where
  extractResolveL : Q(Exp) → MetaM (Option Q(ECtxItem) × Q(Exp))
  | ~q(.resolve $e (.ofVal $v₁) (.ofVal $v₂)) => do
...
def fillItem (e : Q(Exp)) : Q(ECtxItem) → MetaM Q(Exp)
  ...
  | ~q(allocNL $v₂)         => return q(.allocN $e (.ofVal $v₂))
  ...
  | ~q(xchgL $v₂)           => return q(.xchg $e (.ofVal $v₂))
  | ~q(xchgR $e₁)           => return q(.xchg $e₁ $e)
  | ~q(cmpXchgL $v₁ $v₂)    => return q(.cmpXchg $e (.ofVal $v₁) (.ofVal $v₂))
  | ~q(cmpXchgM $e₀ $v₂)    => return q(.cmpXchg $e₀ $e (.ofVal $v₂))
  | ~q(cmpXchgR $e₀ $e₁)    => return q(.cmpXchg $e₀ $e₁ $e)
  | ~q(faaL $v₂)            => return q(.faa $e (.ofVal $v₂))
  | ~q(faaR $e₁)            => return q(.faa $e₁ $e)
  | ~q(resolveL $K $v₁ $v₂) => return q(.resolve $(←fillItem e K) (.ofVal $v₁) (.ofVal $v₂))
  | ~q(resolveM $e₀ $v₂)    => return q(.resolve $e₀ $e (.ofVal $v₂))
