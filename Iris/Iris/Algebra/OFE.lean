...
#rocq_ignore dist_later_lt "Unfold DistLater"
...
#rocq_ignore ofe_iso_1 "Field of `ofe_iso`"
#rocq_ignore ofe_iso_2 "Field of `ofe_iso`"
#rocq_ignore ofe_iso_12 "Field of `ofe_iso`"
#rocq_ignore ofe_iso_21 "Field of `ofe_iso`"
...
#rocq_ignore OFunctor "Constructor for bundled `oFunctor`; Lean uses the `OFunctor` type class."
#rocq_ignore oFunctor_car "Field of bundled `oFunctor`; Lean uses `OFunctorPre` directly."
#rocq_ignore oFunctor_map "Field of bundled `oFunctor`; Lean uses `OFunctor.map`."
#rocq_ignore oFunctor_map_ne "Field of bundled `oFunctor`; Lean uses `OFunctor.map_ne`."
#rocq_ignore oFunctor_map_id "Field of bundled `oFunctor`; Lean uses `OFunctor.map_id`."
#rocq_ignore oFunctor_map_compose "Field of bundled `oFunctor`; Lean uses `OFunctor.map_comp`."
...
#rocq_ignore oFunctor_map_contractive "Field of bundled `oFunctorContractive`; Lean uses `OFunctorContractive.map_contractive`."
...
@[ext, rocq_alias leibnizO] structure LeibnizO (α : Type _) where
  car : α
