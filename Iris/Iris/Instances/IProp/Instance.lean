...
instance intoSep_own {γ} {a b1 b2 : F.ap (IProp GF)} [h : IsOpMerge a b1 b2] :
...
instance intoAnd_own {γ} {a b1 b2 : F.ap (IProp GF)} [h : IsOpMerge a b1 b2] :
...
instance fromSep_own {γ} {a b1 b2 : F.ap (IProp GF)} [h : IsOpMerge a b1 b2] :
...
instance combineSepAs_iOwn {γ} {a b1 b2 : F.ap (IProp GF)} [h : IsOp a b1 b2] :
...
instance fromAndOwn_persistent {a b1 b2 : F.ap (IProp GF)} [h : IsOpMerge a b1 b2]
