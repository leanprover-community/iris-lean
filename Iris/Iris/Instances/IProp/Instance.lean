...
instance intoSep_own {γ} {a : F.ap (IProp GF)} [h : IsSplitOp a b1 b2] :
...
instance intoAnd_own {γ} {a b1 b2 : F.ap (IProp GF)} [h : IsSplitOp a b1 b2] :
...
instance fromSep_own {γ} {a b1 b2 : F.ap (IProp GF)} [h : IsSplitOp a b1 b2] :
...
instance combineSepAs_iOwn {γ} {a b1 b2 : F.ap (IProp GF)} [h : IsMergeOp a b1 b2] :
...
instance fromAndOwn_persistent {γ} {a b1 b2 : F.ap (IProp GF)} [h : IsSplitOp a b1 b2]
