...
theorem metaToken_union_1 {l : L} {E1 E2 : CoPset} (he : E1 ## E2) :
  ...
  icases (OFE.Equiv.of_eq (congrArg (iOwn _) (ReservationMap.token_union he).symm)) $$ Hm with Hm
...
theorem metaToken_union_2 {l : L} {E1 E2 : CoPset} :
  ...
  iexists γm1
  iframe Hγm1
  iapply (equiv_iff.mp (OFE.Equiv.of_eq (congrArg (iOwn _) (ReservationMap.token_union hdisj)))).mpr
  iapply iOwn_op
  iframe
