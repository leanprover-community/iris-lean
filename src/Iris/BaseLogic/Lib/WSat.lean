...
It ports the invariant system from iris-coq's base_logic/lib/wsat.v.
-/
module
...
open BI HeapView BigSepM Std.PartialMap DisjointLeibnizSet DFrac

-- TODO: wrong prec ==∗ and *
-- TODO: dom should be a set
